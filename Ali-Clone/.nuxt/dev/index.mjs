globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, assertMethod, readBody, setCookie, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/h3/dist/index.mjs';
import { PrismaClient } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/@prisma/client/index.js';
import { createRenderer } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/node_modules/radix3/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "supabase": {
      "url": "https://ilpmcqnpamiizclyouxy.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlscG1jcW5wYW1paXpjbHlvdXh5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTAzMDYyODIsImV4cCI6MjAwNTg4MjI4Mn0.Cq3gyoUsKrDj3XhbSlh0iKzBEozMtLO-hHxagd8gE7M",
      "client": {
        "auth": {
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/lexmu/OneDrive/Área de Trabalho/Ali_Clone/Ali-Clone/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\lexmu\\OneDrive\\Área de Trabalho\\Ali_Clone\\Ali-Clone","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\lexmu\\OneDrive\\Área de Trabalho\\Ali_Clone\\Ali-Clone\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\lexmu\\OneDrive\\Área de Trabalho\\Ali_Clone\\Ali-Clone\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\lexmu\\OneDrive\\Área de Trabalho\\Ali_Clone\\Ali-Clone\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _GhLDhe = defineEventHandler(async (event) => {
...
const _lazy_2HADey = () => Promise.resolve().then(function () { return addAddress$1; });
const _lazy_WUxhwc = () => Promise.resolve().then(function () { return createOrder$1; });
const _lazy_xmBRS7 = () => Promise.resolve().then(function () { return _id_$8; });
const _lazy_3RBrgB = () => Promise.resolve().then(function () { return _id_$6; });
const _lazy_gvn8rr = () => Promise.resolve().then(function () { return getAllProducts$1; });
const _lazy_7YIRz4 = () => Promise.resolve().then(function () { return _id_$5; });
const _lazy_ImQz9f = () => Promise.resolve().then(function () { return _id_$3; });
const _lazy_SiZ9og = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_AmG6gq = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/prisma/add-address', handler: _lazy_2HADey, lazy: true, middleware: false, method: undefined },
  { route: '/api/prisma/create-order', handler: _lazy_WUxhwc, lazy: true, middleware: false, method: undefined },
  { route: '/api/prisma/get-address-by-user/:id', handler: _lazy_xmBRS7, lazy: true, middleware: false, method: undefined },
  { route: '/api/prisma/get-all-orders-by-user/:id', handler: _lazy_3RBrgB, lazy: true, middleware: false, method: undefined },
  { route: '/api/prisma/get-all-products', handler: _lazy_gvn8rr, lazy: true, middleware: false, method: undefined },
  { route: '/api/prisma/get-product-by-id/:id', handler: _lazy_7YIRz4, lazy: true, middleware: false, method: undefined },
  { route: '/api/prisma/search-by-name/:id', handler: _lazy_ImQz9f, lazy: true, middleware: false, method: undefined },
  { route: '/api/prisma/update-address/:id', handler: _lazy_SiZ9og, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_AmG6gq, lazy: true, middleware: false, method: undefined },
  { route: '/api/_supabase/session', handler: _GhLDhe, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_AmG6gq, lazy: true, middleware: false, method: undefined }
];
...
const addAddress = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const res = await prisma$6.addresses.create({
    data: {
      userId: body.userId,
      name: body.name,
...
const addAddress$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: addAddress
});
...
const createOrder = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const order = await prisma$5.orders.create({
    data: {
      userId: body.userId,
  ...
  body.products.forEach(async (prod) => {
    await prisma$5.orderItem.create({
      data: {
        orderId: order.id,
...
const createOrder$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: createOrder
});

const prisma$4 = new PrismaClient();
const _id_$7 = defineEventHandler(async (event) => {
  const res = await prisma$4.addresses.findFirst({
    where: { userId: event.context.params.id }
  });
  return res;
});

const _id_$8 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: _id_$7
});
...
const getAllProducts = defineEventHandler(async (event) => {
  let products = await prisma$3.products.findMany();
  return products;
});

const getAllProducts$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const _id_$4 = defineEventHandler(async (event) => {
  let product = await prisma$2.products.findFirst({
...
const _id_$2 = defineEventHandler(async (event) => {
  let items = await prisma$1.products.findMany({
    take: 5,
    // Max rows
    where: {
      title: {
...
const getClientManifest = () => import('file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/lexmu/OneDrive/%C3%81rea%20de%20Trabalho/Ali_Clone/Ali-Clone/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<script src=\"https//js.stripe.com/v3/\" defer=\"\"></script>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
